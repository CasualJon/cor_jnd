      ...
      case 'get_next_question':
        ...
        if (!is_null($_POST['arguments']) && !empty($_POST['arguments'])) {
          ...
          if (strpos($_SESSION['exp_data'][$_SESSION['survey']['curr_question']][$choice], $engagement_string_check[0]) !== FALSE ||
            ...
            if (strpos($_SESSION['exp_data'][$_SESSION['survey']['curr_question']][$choice], "_x209a") !== FALSE) $_SESSION['engagement'][0] = $usr_correct;
            else if (strpos($_SESSION['exp_data'][$_SESSION['survey']['curr_question']][$choice], "_x209b") !== FALSE) $_SESSION['engagement'][1] = $usr_correct;

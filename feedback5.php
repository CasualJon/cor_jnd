...
<html>
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h3>Feedback #5 <span class="semi_transp">(of 5)</span></h3>
        </div> <!-- /column -->
      </div> <!-- /row -->
      <hr />
          ...
          <?php
            ...
            if ($_GET['sel'] == "A") {
              echo '
                ...
                <p>
                  Here, the plot on the left has a correlation of 0.4 while the
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <button class="btn btn-lg btn-outline-danger" onclick="executeUserSelection(6)" id="continue_button" disabled>
